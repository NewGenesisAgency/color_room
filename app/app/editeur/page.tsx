              ...
              <div style={{ margin: 'auto', textAlign: 'center', color: 'rgba(15,23,42,0.55)', fontSize: 13, maxWidth: 340 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {[
                    ...
                    { t: 'Simon (mémoire de séquence, difficulté)', p: "Crée un \"Simon\" de mémoire : le jeu allume une séquence de dalles colorées de plus en plus longue, le joueur doit la reproduire dans l'ordre en cliquant les dalles. Écran de config au départ pour choisir la difficulté 1/2/3 (vitesse d'affichage de la séquence). À chaque manche réussie, la séquence s'allonge d'une dalle et on gagne des points ; une erreur joue \"wrong\" et termine la partie. Joue un son différent par couleur, \"correct\" à chaque bonne entrée et \"win\" aux paliers. Affiche le score et le numéro de manche. NE mets PAS de grille de dalles dans l'interface : la salle est déjà visible en 3D." },
                  ].map((ex) => (
